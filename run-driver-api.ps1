...
$env:PASSKEY_ORIGIN     = "http://localhost:4002"
...
Write-Host "Starting Driver API on http://localhost:4002 ..." -ForegroundColor Cyan
node apps/driver-api/dist/main.js
