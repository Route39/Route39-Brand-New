...
class OrderInProgressSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final dropoff = order.waypoints.toPlaces.length > 1
        ? order.waypoints.toPlaces.last
        : null;
    final driverName = (order.driver?.fullName?.isNotEmpty ?? false)
                    ...
                    children: [
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    Text(
                                      order.driver?.rating?.toStringAsFixed(
                                            1,
                                          ) ??
                                          '-',
                                      style: context.bodySmall?.copyWith(
                      ...
                      if (hasArrived || isStarted) ...[
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color: ColorPalette.primary40.withValues(
                              alpha: 0.08,
                            ),
                            ...
                            child: ElevatedButton.icon(
                              ...
                              onPressed: () {
                                showDialog(
                                  ...
                                  useSafeArea: false,
                                  builder: (context) =>
                                      CancelRideReasonDialog(orderId: order.id),
                                );
                              },
