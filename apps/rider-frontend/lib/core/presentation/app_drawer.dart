...
import 'package:ridy/core/blocs/route.dart';
import 'package:ridy/core/extensions/extensions.dart';
import 'package:flutter_common/core/presentation/avatars/app_avatar.dart';
import 'package:ridy/config/router/nav_item.dart';
...
class AppDrawer extends StatelessWidget {
  ...
  const AppDrawer({super.key, this.showHeader = true, required this.scaffoldKey});
                        ...
                        child: Row(
                          children: [
                            ...
                            switch (state) {
                              ...
                              AuthState$Authenticated(:final profile) => Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text(profile.fullName, style: context.labelMedium),
                                  Text(
                            ...
                            children: [
                              ...
                              ...(state.isAuthenticated
                                      ? signedInNavItems.where(
                                          (element) => context.responsive(true, xl: element != NavItem.announcements),
                                        )
                                      : signedOutNavItems)
                                  .map(
                                    (e) => AppDrawerItem(
                                      ...
                                      badgeCount: e == NavItem.reservedRides && state.isAuthenticated
                                          ? locator<HomeBloc>().state.scheduledRidesResponse.data?.length ?? 0
                                          : 0,
