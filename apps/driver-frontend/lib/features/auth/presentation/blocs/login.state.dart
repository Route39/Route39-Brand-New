...
sealed class LoginState with _$LoginState {
  const factory LoginState({
    ...
    @Default([]) List<Query$RegistrationData$driverRequiredDocuments> requiredDocuments,
    ...
    @Default(false) bool showLicenseUpload,
    @Default(false) bool licenseSubmitted,
    @Default(false) bool showProfileInfo,
    @Default(false) bool profileInfoSubmitted,
    ...
    String? draftLicenseNumber,
    String? draftProfileFirstName,
    String? draftProfileLastName,
    String? draftProfileDob,
    String? draftProfileGender,
    @Default(false) bool showVehicleRC,
    @Default(false) bool vehicleRCSubmitted,
    String? vehicleOwnership,
    String? vehicleNumberValue,
    String? draftVehicleOwnership,
    String? draftVehicleNumber,
    @Default(false) bool showAadhaarPan,
    @Default(false) bool aadhaarPanSubmitted,
    String? aadhaarNumberValue,
    String? panNumberValue,
    String? draftAadhaarNumber,
    String? draftPanNumber,
  }) = _LoginState;
